...
\rhead{\includegraphics[height=45pt]{images/icacsis_logo_color.png}} % image in header
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=north, inner sep=0pt]
    at ([yshift=-17.5cm]current page.north)
    {\includegraphics[width=10cm]{images/icacsis_logo.png}};

  \node[anchor=north, text width=150mm, align=justify]
    at ([yshift=-20cm]current page.north)
<<<<<<< HEAD
    {\Large The $15^{th}$  International Workshop on Big Data and Information Security (IWBIS) provides an international forum that brings together those who are actively involved in the field of Computer Science and Information Systems.};
=======
    {\Large The $15^{th}$  International Conference on Advanced Computer Science and Information Systems (ICACSIS) provides an international forum that brings together those who are actively involved in the field of Computer Science and Information Systems.};
>>>>>>> 5b4f49b (first commit, masih minjem dari ICACSIS)
...
\begin{tabularx}{0.85\textwidth}{@{}>{\raggedright\arraybackslash}p{3.4cm} >{\raggedright\arraybackslash}X@{}}
  ...
  \rowcolor{lightgraybg}
  Conference Website & \url{https://icacsis.cs.ui.ac.id} \\
...
=======
  {\color{conf}\fontsize{36}{40}\selectfont\bfseries ICACSIS 2026}\\[0.2em]
  {\Large International Conference on Advanced Computer Science and Information Systems}\\[0.2em]
  {\large October 16--18, 2026 \;•\; Depok, Indonesia \;•\; https://icacsis.cs.ui.ac.id/}
>>>>>>> 5b4f49b (first commit, masih minjem dari ICACSIS)
\end{center}
...
\hspace*{2em}\textcolor{gray}{Margo Hotel (Tentatif)}\\
...
\hspace*{2em}\textcolor{gray}{Selasar Audit}\\
...
\hspace*{2em}\textcolor{gray}{Selasar Audit, Lunch Prasmanan (pisah antara VIP dan peserta)}\\
\textbf{13:10 -- 13:40}~~Keynote 5: Rektor\\
\hspace*{2em}\textcolor{gray}{Auditorium Indro Suwandi}\\
...
\hspace*{2em}\textcolor{gray}{Selasar Audit}\\
\textbf{16:05 -- 16:50}~~Invited Speaker 1 ICACSIS (Henry) + Invited Speaker 2 Anwar (Online) \emph{(Parallel)}\\
...
\hspace*{2em}\textcolor{gray}{Selasar Audit, Seluruh Peserta, Award Best Paper}
